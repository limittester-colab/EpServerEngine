...
namespace EpServerEngineSampleClient
{
	public partial class EasyButtonForm : Form
	{
		...
		{
			lbPort.Items.Clear();
			lbPort.Items.Add("CABIN_SOUTH");
			lbPort.Items.Add("CABIN2");
			lbPort.Items.Add("CABIN3");
			lbPort.Items.Add("CABIN_KITCHEN");
			lbPort.Items.Add("CABIN_DOOR");
			lbPort.Items.Add("CABIN_EAST");
		...
		private void rbFunc6_CheckChanged(object sender, EventArgs e)
		{
			func = 6;
		}
		private void rbFunc7_CheckChanged(object sender, EventArgs e)
		{
			func = 7;
		}
