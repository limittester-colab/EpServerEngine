...
namespace EpServerEngineSampleClient
{
	partial class EasyButtonForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.rbFunc6 = new System.Windows.Forms.RadioButton();
			this.rbFunc7 = new System.Windows.Forms.RadioButton();
			this.SuspendLayout();
			// 
			// lbClientType
			// 
			...
			// rbFunc6
			// 
			this.rbFunc6.AutoSize = true;
			this.rbFunc6.Location = new System.Drawing.Point(354, 174);
			this.rbFunc6.Name = "rbFunc6";
			this.rbFunc6.Size = new System.Drawing.Size(75, 17);
			this.rbFunc6.TabIndex = 18;
			this.rbFunc6.TabStop = true;
			this.rbFunc6.Text = "Function 6";
			this.rbFunc6.UseVisualStyleBackColor = true;
			this.rbFunc6.CheckedChanged += new System.EventHandler(this.rbFunc6_CheckChanged);
			// 
			// rbFunc7
			//
			this.rbFunc7.AutoSize = true;
			this.rbFunc7.Location = new System.Drawing.Point(354, 197);
			this.rbFunc7.Name = "rbFunc7";
			this.rbFunc7.Size = new System.Drawing.Size(75, 17);
			this.rbFunc7.TabIndex = 19;
			this.rbFunc7.TabStop = true;
			this.rbFunc7.Text = "Function 7";
			this.rbFunc7.UseVisualStyleBackColor = true;
			this.rbFunc7.CheckedChanged += new System.EventHandler(this.rbFunc7_CheckChanged);
			// 
			// btnQuit
			// 
			...
			this.Controls.Add(this.rbFunc6);
			this.Controls.Add(this.rbFunc7);
		...
		private System.Windows.Forms.RadioButton rbFunc6;
		private System.Windows.Forms.RadioButton rbFunc7;
	}
}