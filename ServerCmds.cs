...
namespace EpServerEngineSampleClient
{
	class ServerCmds
	{
		...
		public bool SetProperties(bool iparam, string which)
		{
			switch (which)
			{ 
				case "DESK_LIGHT":
				...
				break;
					case "CHICK_LIGHT":
						Properties.Settings.Default["CHICK_LIGHT"] = iparam;
				break;
					case "CHICK_HEATER":
						Properties.Settings.Default["CHICK_HEATER"] = iparam;
				break;
					case "BENCH_12V_1":
				...
				break;
					case "CABIN_SOUTH":
						Properties.Settings.Default["CABIN_SOUTH"] = iparam;
				break;
					case "CABIN2":
				...
				break;
					case "CABIN_KITCHEN":
						Properties.Settings.Default["CABIN_KITCHEN"] = iparam;
				break;
					case "CABIN_DOOR":
						Properties.Settings.Default["CABIN_DOOR"] = iparam;
				break;
					case "CABIN_EAST":
						Properties.Settings.Default["CABIN_EAST"] = iparam;
				break;
					case "CABIN7":
		...
		public bool GetState(int msg)
		{
			...
			switch(GetName(msg))
			{
				...
				case "SOUTHWEST_LIGHT":
					...
					break;
				case "CHICK_LIGHT":
					current_state = (bool)Properties.Settings.Default["CHICK_LIGHT"];
					break;
				case "CHICK_HEATER":
					current_state = (bool)Properties.Settings.Default["CHICK_HEATER"];
					break;
				case "BENCH_12V_1":
				...
				case "BENCH_LIGHT2":
					...
					break;
				case "CABIN_SOUTH":
					current_state = (bool)Properties.Settings.Default["CABIN_SOUTH"];
					break;
				case "CABIN2":
				...
				case "CABIN3":
					...
					break;
				case "CABIN_KITCHEN":
					current_state = (bool)Properties.Settings.Default["CABIN_KITCHEN"];
					break;
				case "CABIN_DOOR":
					current_state = (bool)Properties.Settings.Default["CABIN_DOOR"];
					break;
				case "CABIN_EAST":
					current_state = (bool)Properties.Settings.Default["CABIN_EAST"];
					break;
				case "CABIN7":
...
/*
			switch(GetName(msg))
			{
				...
				case "SOUTHWEST_LIGHT":
					...
					break;
				case "CHICK_LIGHT":
					Properties.Settings.Default["CHICK_LIGHT"] = current_state;
					break;
				case "CHICK_HEATER":		
					Properties.Settings.Default["CHICK_HEATER"] = current_state;
					break;
				case "BENCH_12V_1":
				...
				case "BENCH_LIGHT2":
					...
					break;
				case "CABIN_SOUTH":
					Properties.Settings.Default["CABIN_SOUTH"] = current_state;
					break;
				case "CABIN2":
				...
				case "CABIN3":
					...
					break;
				case "CABIN_KITCHEN":
					Properties.Settings.Default["CABIN_KITCHEN"] = current_state;
					break;
				case "CABIN_DOOR":
					Properties.Settings.Default["CABIN_DOOR"] = current_state;
					break;
				case "CABIN_EAST":
					Properties.Settings.Default["CABIN_EAST"] = current_state;
					break;
				case "CABIN7":
